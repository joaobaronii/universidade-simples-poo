...
//map por ser mais eficiente com buscas
...
public class Main {
            ...
            try {
                ...
                switch (opt) {
                    case 1:
                        ...
                        Disciplina disciplina = new Disciplina(disNome, disCodigo, disCargaHoraria);
                        turmas.put(codigo, new Turma(new ArrayList<Estudante>(100), prof, ano, semestre, disciplina));
                        System.out.println("\n\n\n");
    ...
    private static Map<String, Turma> populate() {
        ...
        // abre o arquivo
        try(BufferedReader reader = new BufferedReader(new FileReader("src/resources/data.txt")))
        {
            ...
            while(buffer != null)
            {
                ...
                Disciplina disc = new Disciplina(disciplina[0], disciplina[1], disciplina[2]);
                turmas.put(turmaNome, new Turma(estudantes, prof, ano, semestre, disc));
    ...
    private static ArrayList<Notas> populateNotas() {
        ...
        // abrimos o arquivo
        try(BufferedReader reader = new BufferedReader(new FileReader("src/resources/dataNotas.txt")))
        {
    ...
    public static void writeTurmas(Map<String, Turma> turmas)
    {
        try(BufferedWriter writer = new BufferedWriter(new FileWriter("src/resources/data.txt")))
        {
            for(Map.Entry<String, Turma> entry : turmas.entrySet())
            {
                Disciplina d = entry.getValue().getDisciplina();
                String disNome = d.getNome();
                String disCodigo = d.getCodigo();
                String disCargaHoraria = d.getCargaHoraria();
    ...
    {
        try(BufferedWriter writer = new BufferedWriter(new FileWriter("src/resources/dataNotas.txt")))
        {
            for(Notas n : notas)
            {
